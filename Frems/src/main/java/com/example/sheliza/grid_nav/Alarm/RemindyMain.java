...
public class RemindyMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_remindy_main);
        ...
        mAddReminderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(RemindyMain.this, ReminderAddActivity.class);
    ...
    public class SimpleAdapter extends RecyclerView.Adapter<SimpleAdapter.VerticalItemHolder> {
        ...
        public  class VerticalItemHolder extends SwappingHolder
            ...
            public boolean onLongClick(View v) {
                AppCompatActivity activity = RemindyMain.this;
            ...
            public void setActiveImage(String active){
                if(active.equals("true")){
                    mActiveImage.setImageResource(R.color.primary);
